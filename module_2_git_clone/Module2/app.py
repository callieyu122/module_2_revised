...
def save_csv(csvpath,qualiying_loans):
    #write the code to save list of lists to the CSV file
    #iterate through the list and call the function to write to csv file 
    #by calling function write_csv
    write_csv(csvpath,qualiying_loans)
